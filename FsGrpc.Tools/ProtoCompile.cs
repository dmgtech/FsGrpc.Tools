...
namespace Grpc.Tools
{
    ...
    public class ProtoCompile : ToolTask
    {
        ...
        */
        ...
        /// Switch: --plugin=protoc-gen-fsgrpc=
        /// </summary>
        ...
        protected override string GenerateResponseFileCommands()
        {
            ...
            //Log.LogWarning($"Tool Path: {ToolExe}");
            //Log.LogWarning($"File Commands: {LogToolCommandImpl(result)}");
        ...
        {
            base.LogToolCommand(LogToolCommandImpl(cmd));
        }
        protected string LogToolCommandImpl(string cmd)
        {
